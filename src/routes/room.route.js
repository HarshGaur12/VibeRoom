...
import { createRoom, endRoom, getRoomHistory, joinRoom, leaveRoom, deleteAllRoomsHistory, updateRoomSettings, updateParticipantAccess } from '../controllers/room.controller.js';
...
router.route("/:roomCode/participant/:participantId").patch(verifyJWT, updateParticipantAccess);
